...
const playerVariants = [
  ...
  { id: 'striker', tier: 1, name: 'Striker', price: 50, color: '#FF0033', power: 1.3, accuracy: 1.6 },
  { id: 'sniper', tier: 2, name: 'Sniper', price: 100, color: '#00FF33', power: 1.5, accuracy: 1.8 },
  { id: 'legend', tier: 3, name: 'Legend', price: 500, color: '#FFD700', power: 3.0, accuracy: 3.0 }
];
